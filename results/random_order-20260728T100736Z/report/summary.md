...
- The largest exact-theory absolute packet-loss difference was 0.001585 at ρ=1.0, K=4.
## Main quantitative findings

- The mean fitted collision-scaling exponent across available configurations was 0.953.
- The largest observed policy range was 0.00645 at ρ=1.1, K=4, δ=0.1.
- The critical-collision predictor model had R²=0.695.
...
`juncture analyze --run-dir results/random_order-20260728T100736Z`
