...
- The largest exact-theory absolute packet-loss difference was 0.0829027 at ρ=0.8, K=4.
## Main quantitative findings

- The largest observed policy range was 0.00018 at ρ=0.8, K=4, δ=0.01.
- The critical-collision predictor model had R²=0.287.
...
`juncture analyze --run-dir results/distributional_dm-20260728T110914Z`
